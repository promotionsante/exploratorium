...
```{r function-consolidate_topic_data}
#' Consolidate topic data
#' 
...
```{r example-consolidate_topic_data}
# Load the toy datasets
data("toy_data_pgv")
data("toy_dic_variables")
data("toy_cantons_sf")
...
```{r tests-consolidate_topic_data}
...
# Translate the value of a given column with `translate_values_in_col()`

```{r function-translate_values_in_col}
...
```{r example-translate_values_in_col}
# Load the toy datasets
data("toy_data_pgv")
data("toy_dic_variables")
data("toy_dic_values")
...
```{r tests-translate_values_in_col}
...
```{r function-compute_project_completion_percentage}
...
```{r example-compute_project_completion_percentage}
...
```{r tests-compute_project_completion_percentage}
